 ...
 */
final class Version20241010094227 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD category_id INT NOT NULL, CHANGE prix prix NUMERIC(10, 2) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP category_id, CHANGE prix prix NUMERIC(10, 2) DEFAULT NULL');
    }
}
